    ...
    public String buildRoleplayUserPrompt(
        ...
        if (personalizedWords != null && !personalizedWords.isEmpty()) {
            ...
            sb.append("""
                    ...
                    Prefer to include exactly 1 of these words naturally in this reply when context allows.
                    If none fits naturally, you may skip them to keep the response correct and fluent.
                    Never list the words explicitly.
                    If you use a personalized word, wrap that exact word in markdown bold using **word**.
                    Keep bold formatting only for personalized words you actually used.
